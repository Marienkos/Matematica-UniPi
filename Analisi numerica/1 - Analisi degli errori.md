...
Sia $f$ approssimabile con Taylor. Allora $\varepsilon_{\text{in}} \simeq \frac{xf'(x)}{f(x)}\varepsilon_{x}$ dove $\frac{xf'(x)}{f(x)}$ è detto coefficiente di amplificazione. Si estende a $\mathbb{R}^n$ con le derivate parziali.