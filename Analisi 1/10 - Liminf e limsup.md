...
DIMOSTRAZIONE: $S_{n} \to -\infty \implies S_{n} \leq M$ definitivamente $\implies a_{n} \leq M$ definitivamente
...
DIMOSTRAZIONE: Confronto coi limiti di $S_{n}^a$, $S_{n}^b$, $I_{n}^a$ e $I_{n}^b$.
...
DIMOSTRAZIONE: Definizione e confronto.
...
DIMOSTRAZIONE: Definizione e presentazione per maggioranti.
...
DIMOSTRAZIONE: Definizione con $S_{n}$ e passaggio al limite.
